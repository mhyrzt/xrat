---
id: TASK-13
title: 'Medium, P2: Runtime Mux settings for generated Xray outbounds'
status: Done
assignee: []
...
Legacy path: `docs/backlog/feature/runtime-mux-settings.md`

# Medium, P2: Runtime Mux settings for generated Xray outbounds

### Status

Implemented as `[runtime.mux]` (applied to the proxy outbound of generated
runtime and probe configs).
