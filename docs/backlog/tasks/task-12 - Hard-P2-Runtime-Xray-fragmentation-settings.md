---
id: TASK-12
title: 'Hard, P2: Runtime Xray fragmentation settings'
status: Done
assignee: []
...
Legacy path: `docs/backlog/feature/runtime-fragmentation-settings.md`

# Hard, P2: Runtime Xray fragmentation settings

### Status

Implemented as `[runtime.fragment]` (chains the proxy outbound through a
`freedom` fragment outbound via `sockopt.dialerProxy`).
