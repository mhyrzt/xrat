use super::{
    AppConfig, ConnectionTestStage, DatabaseBackend, DnsHostValue, SecretString, TestFailurePolicy,
    load, resolve_config_path,
};
...
fn parses_example_config() {
    let config: AppConfig = toml::from_str(include_str!("../../../docs/plan/config.example.toml"))
