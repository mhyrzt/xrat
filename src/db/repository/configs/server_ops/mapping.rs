    ...
    R::Database: Database,
{
    ...
    ConfigWithLatestTest {
        ...
        dial_endpoint_location: row.get("lt_endpoint_location"),
        dial_endpoint_country: row.get("lt_endpoint_country"),
        dial_endpoint_asn: row.get("lt_endpoint_asn"),
        dial_endpoint_geoip_source: row.get("lt_endpoint_geoip_source"),
        dial_endpoint_fronting: row.get("lt_endpoint_fronting"),
