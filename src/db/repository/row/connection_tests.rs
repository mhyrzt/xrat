    ...
    R::Database: Database,
{
    ConnectionTestRecord {
        ...
        dial_endpoint_ip: row.get("dial_endpoint_ip"),
        dial_endpoint_location: row.get("dial_endpoint_location"),
        dial_endpoint_country: row.get("dial_endpoint_country"),
        dial_endpoint_asn: row.get("dial_endpoint_asn"),
        dial_endpoint_geoip_source: row.get("dial_endpoint_geoip_source"),
        dial_endpoint_fronting: row.get("dial_endpoint_fronting"),
